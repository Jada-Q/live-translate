...
### 菜单栏控制面板
![菜单栏控制面板](assets/control-panel.png)

点屏幕右上角的喇叭图标 → 弹出控制面板。选方向（5 个翻译方向）、开始 / 停止翻译、唤出浮动字幕条、打开打字翻译窗口。

### 打字翻译窗口
![打字翻译窗口](assets/type-translate.png)

写邮件 / 发消息给外国人时打字翻译。左边打中文，右边实时翻成英文或日文（350 ms 防抖），方向可切，一键复制译文。
